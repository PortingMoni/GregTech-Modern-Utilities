...
public class MEEnlargedTagStockingInputHatchPartMachine extends METagStockingInputHatchPartMachine {
    ...
    public MEEnlargedTagStockingInputHatchPartMachine(BlockEntityCreationInfo info) {
